...
class Sys {
   ...
   static function get_dirname():String {
   		return Node.__dirname;
   }
   
   static function get_Assert() {
   	return Node.assert;
   }
  ...
  public static function genPasswd(val) { 
	...
	public static inline function require(module:String) {
		return Node.require(module);
	}

         
  public static inline function events() {
    return _events;
  }
  
  public static inline function argv() {
    return _proc.argv;
  }
  ...
  public static inline function pid() {
    return _proc.pid;
  }

  public static inline function title() {
    return _proc.title;
  }
  ...
  public static inline function platform() {
    return _proc.platform;
  }

  public static inline function installPrefix() {
    return _proc.installPrefix;
  }

  public static inline function execPath() {
    return _proc.execPath;
  }

  public static inline function version() {
    return _proc.version;
  }

  public static inline function versions() {
    return _proc.versions;
  }
  
  public static inline function memoryUsage():{rss:Int,vsize:Int,heapUsed:Int,heapTotal:Int} {
    return _proc.memoryUsage();
  }
  
  public static inline function nextTick(fn:Void->Void) {
    _proc.nextTick(fn);
  }
  ...
  public static inline function cwd() {
    return _proc.cwd();
  }
  
  public static inline function getuid():Int {
    return _proc.getuid();
  }
  
  public static inline function getgid():Int {
    return _proc.getgid();
  }
  
  public static inline function setuid(u:Int) {
    _proc.setuid(u);
  }
  
  public static inline function setgid(g:Int) {
    _proc.setgid(g);
  }
  
 public static inline function umask(?m:Int):Int {
    return _proc.umask(m);
  }
  
  public static inline function chdir(d:String) {
    _proc.chdir(d);
  }
  
  public static inline function kill(pid:Int,?signal:String) {
    _proc.kill(pid,signal);
  }
  
  public static inline function uptime():Int {
    return _proc.uptime();
  }
 
  public static inline function hostname():String {
    return _os.hostname();
  }
  
  public static inline function type():String {
    return _os.type();
  }
  
  public static inline function release():String {
    return _os.release();
  }
  
  public static inline function osUptime():Int {
    return _os.uptime();
  }
  
  public static inline function loadavg():Array<Float> {
    return _os.loadavg();
  }
  
  public static inline function totalmem():Int {
    return _os.totalmem();
  }
  
  public static inline function freemem():Int {
    return _os.freemem();
  }
  
  public static inline function cpus():Int {
    return _os.cpus();
  }
  
  public static inline function networkInterfaces():Dynamic {
  ...
  public static function readFile(path:String,?enc:SysEnc):TOutcome<String,String>{
    ...
    Node.fs.readFile(path,Sys.getEnc(enc),function(err,s) {
        oc.complete((err != null) ? Failure(err) : Success(new String(s)));
      });
    return oc;
  }
